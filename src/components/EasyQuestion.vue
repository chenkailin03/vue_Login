<template>
	<el-row style="display: block;">
		<el-row class="backstyle" >
			<el-col span="18" style="min-height: 0px;">
            <!-- 中间题目 -->
						<el-main class="content_style" style="margin-right: 0px;">
							<el-container>
								<el-header class="other_header" style="height: 40px;line-height: 20px;text-align: center; color:#5D9CEC ;">海洋动物答题挑战第一关</el-header>
								<el-main style="background-color: aliceblue;">
									<el-row>
										<el-row :class="`classabc${index+1}`" v-for="(item,index) in datalist" :key="index" style="margin-bottom: 20px;">
											<el-col span="2">
											...
											<el-col span="21">
												...
												<el-row style="margin-top: 20px;" v-for="citem in item.result" :key="citem">
		...
		data() {
			return {
				...
				datalist: [{
					...
					title: '条件一：没有老师是哑巴；条件2:所有的老师都是法国人；那么我们能得到的结论是:',
					answer: 'A',
					radio: '',
					show: '',
					result: [{
