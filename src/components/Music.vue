<template>
  ...
  export default {
    data() {
        return {
            ...
            musicName: "大海岸边涛声",
            audioPathDic: {
                大海岸边涛声: require("../views/disney/music/海浪声/大海岸边涛声.mp3"),
                海底气泡: require("../views/disney/music/海浪声/海底气泡.mp3"),
                风平浪静的岸边微弱的海浪声: require("../views/disney/music/海浪声/风平浪静的岸边微弱的海浪声.mp3"),
                暴雨时波涛汹涌的大海: require("../views/disney/music/海浪声/暴雨时波涛汹涌的大海.mp3"),
                风和海浪: require("../views/disney/music/海浪声/风和海浪.mp3"),
            },
        };
    },
    methods: {
        ...
        timeupdate(e) {
            ...
            if (!this.isDraging) {
                this.currentRate = Math.floor((e.target.currentTime / this.$refs.Ref_audioPlayer.duration) * 100);
        ...
        currentRateChange(newVal) {
            this.$refs.Ref_audioPlayer.currentTime = Math.round((newVal / 100) * this.$refs.Ref_audioPlayer.duration);
            this.$refs.Ref_audioPlayer.play();
        },
        // 获取播放状态
        getPlayStatus() {
  ...
  .container /deep/ {
    ...
    margin-top: 10px;
    margin-left: 10px;
    background: linear-gradient(rgb(212, 230, 249), rgb(251, 237, 240));
  }
  .listBox {
    text-align: left;
  }
