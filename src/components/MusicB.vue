<template>
  ...
  export default {
    data() {
      return {
        ...
        musicName: "成群飞翔的海鸥",
        audioPathDic: {
          海鸥: require("../views/disney/music/动物的叫声/海鸥.mp3"),
          鲸鱼: require("../views/disney/music/动物的叫声/鲸鱼.mp3"),
          海象: require("../views/disney/music/动物的叫声/海象.mp3"),
          斑脸海番鸭: require("../views/disney/music/动物的叫声/斑脸海番鸭.mp3"),
          海鸥和海浪: require("../views/disney/music/动物的叫声/海鸥和海浪.mp3"),
        },
      };
    },
    methods: {
  ...
  .container /deep/ {
    ...
    margin-top: -650px;
    margin-left: 970px;
    background: linear-gradient(rgb(215, 231, 249), rgb(249, 248, 210));
  }
  .listBox {
    text-align: left;
  }
